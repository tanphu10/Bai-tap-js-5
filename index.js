...
document.getElementById('tongDiemTB').onclick=function(){
    ...
    var tongDiem= (diemThuNhat+diemThuHai+diemThuBa + diemCongKhuVuc +diemCongDoiTuong);
        if (tongDiem>= diemChuan && diemThuNhat>0 && diemThuHai>0  && diemThuBa>0){
            xepLoai = "Đạt";
        }else{
            xepLoai = "không Đạt";
        }
    ...
    document.getElementById('diemTrungBinhBaMon').value= "tổng điểm: " +tongDiem + " _kết luận: " + xepLoai;
...
if(soKw <= 50 ){
    ...
    tinhTongTienDien= tien50KwDauTien*50 + tien50KwTiepTheo*50 +tien100KwTiepTheo*(soKw-100)
}else if(soKw>200 && soKw<=350){
    tinhTongTienDien= tien50KwDauTien*50 + tien50KwTiepTheo*50 +tien100KwTiepTheo*100
    +tien150KwTiepTheo*(soKw-200)
}if (350<soKw){
    tinhTongTienDien= tien50KwDauTien*50 + tien50KwTiepTheo*50 +tien100KwTiepTheo*100
    +tien150KwTiepTheo*(150)+tienKwConLai*(soKw-350)
}

document.getElementById('tongTienDien').value="Tổng tiền điện của " +tenNguoiDung +" là " +tinhTongTienDien +" VNĐ";
}
...
function tongThueCaNhan(){
    ...
    var chiuThue =thuNhap1Nam -tienCaNhan -tongnguoiPhuThuoc*tienNguoiPhuThuoc;
